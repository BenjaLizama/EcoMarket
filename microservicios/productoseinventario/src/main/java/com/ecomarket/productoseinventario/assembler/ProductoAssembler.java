...
public class ProductoAssembler implements RepresentationModelAssembler<Producto,EntityModel<Producto>> {
    ...
    public EntityModel<Producto> toModel(Producto producto){
        return EntityModel.of(producto,
                linkTo(methodOn(ProductoController.class).obtenerProducto(producto.getIdProducto())).withRel("obtener productos"),
                ...
                linkTo(methodOn(ProductoController.class).actualizarCategoriaProducto(producto.getIdProducto(), null)).withRel("actualizar categoria"),

                linkTo(methodOn(ProductoController.class).actualizarStockProducto(producto.getIdProducto(),null)).withRel("actualizar stock del producto")
